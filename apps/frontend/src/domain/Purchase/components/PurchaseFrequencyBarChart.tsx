...
import { mapToPurchaseChartData } from '@domain/Purchase/utils/mapToReChartsData'
...
function PurchaseFrequencyBarChart({ queryParams }: Props) {
  ...
  const chartData = useMemo(() => mapToPurchaseChartData(purchaseFrequency), [purchaseFrequency])
...
export default PurchaseFrequencyBarChart
